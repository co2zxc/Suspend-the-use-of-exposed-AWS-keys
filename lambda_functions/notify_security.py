...
TEMPLATE = '''At {} the IAM access key {} for user {} on account {} was disable after it was found to have been publicly exposed on the internet.
...
ERROR_MSG = '''An error occured when attempting to disable an exposed IAM access key for one of your IAM users. Please login to your account and navigate to the Personal Health Dashboard for more details on this incident and how to resolve it.
